	...
	<div class="container">
		<div class="row">
			<div class="col-6 offset-3">
				<h1 class="text-uppercase fw-bold mb-4 text-center">About Us</h1>
				<p class="text-center">
					Spare Bytes is a trusted provider of computer spare parts for businesses and individuals alike. 
					We offer a wide selection of high-quality parts at competitive prices, including motherboards, CPUs, hard drives, 
					and more.
				</p>
			</div>
		</div>
