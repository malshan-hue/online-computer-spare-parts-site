			...
			<div class="col-8 offset-2">
				<form action="<%= request.getContextPath()%>/AddCategoryServlet" method="POST">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="catName" aria-describedby="emailHelp" placeholder="Enter Category Name" name="catName">
					</div>
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="catDesc" rows="3" name="catDescription"></textarea>
					</div>
					
					<br>
					
					<div class="form-group">
						<label for="exampleInputEmail1">Category Created Date</label>
						<input type="date" class="form-control" id="catCreatedDate" aria-describedby="emailHelp" placeholder="Enter Category Created Date" name="createdDate">
					</div>
					...
					<div class="form-group">
						...
						<a class="btn btn-primary btn-block" href="categoryList.jsp" role="button">View All Categories</a>
					</div>
