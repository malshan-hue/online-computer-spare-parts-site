				...
				<table class="table table-dark">
					<thead>
						<tr>
						  ...
						  <th scope="col">Brand Focus On</th>
						  <th scope="col">Brand Portfolio</th>
					...
					<tbody>
						...
						<%	
							...
							ArrayList<Brand> arrayList = iBrandService.getBrands();
						%>
						...
						<%	for(Brand brand: arrayList){ %>
							<tr>
								...
								<td><%= brand.getBrandOrigin() %></td>
								<td><%= brand.getBrandProductFocus() %></td>
								<td><%= brand.getBrandProductPortfolio() %></td>
								<td>
									<form action="<%= request.getContextPath()%>/GetBrandServlet" method="post">
											<div class="form-group">
												<input type="hidden" value="<%= brand.getBrandID() %>" name="brandID">
												<input type="submit" value="Edit" class="btn btn-outline-light btn-sm">
											</div>
									</form>
								</td>
								<td>
									<form action="<%= request.getContextPath()%>/DeleteBrandServlet" onsubmit="return confirmDelete(this)" method="post">
											<div class="form-group">
												<input type="hidden" value="<%= brand.getBrandID() %>" name="brandID">
