			...
			<div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
				<div class="d-flex justify-content-center align-items-center h-100">
					<div class="text-white">
						<br><br><br>
						<h1 class="mb-3">Update Brands</h1>
		...
		<div class="row">
			<div class="col-8 offset-2">
				...
				<%
					...
					ArrayList<Brand> arrayList = iBrandService.getBrandById(brandID);
				...
				%>
					<form action="<%= request.getContextPath()%>/UpdateBrandServlet" method="POST">
					
						<div class="form-group">
							<input type="hidden" class="form-control" value="<%= brandID %>" name="brandID">
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">Brand Name</label>
							<input type="text" class="form-control" value="<%= brand.getBrandName() %>" placeholder="Enter Brand Name" name="brandName">
						</div>
						...
						<div class="form-group">
							...
							<select class="form-control" name="brandOrigin">
								<option value="<%= brand.getBrandOrigin() %>" selected><%= brand.getBrandOrigin() %></option>
						...
						<div class="form-group">
							...
							<select class="form-control" name="brandProductFocus">
								<option value="<%= brand.getBrandProductFocus() %>" selected><%= brand.getBrandProductFocus() %></option>
						...
						<div class="form-group">
							...
							<select class="form-control" name="brandProductPortfolio">
								<option value="<%= brand.getBrandProductPortfolio() %>" selected><%= brand.getBrandProductPortfolio() %></option>
