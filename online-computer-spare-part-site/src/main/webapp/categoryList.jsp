				...
				<table class="table table-dark">
					<thead>
						<tr>
						  ...
						  <th scope="col">Category Created Date</th>
						  <th scope="col">Category Updated Date</th>
					...
					<tbody>
						...
						<%	for(Category category: arrayList){ %>
							<tr>
								...
								<td><%= category.getCatCreatedDate() %></td>
								<td><%= category.getCatUpdatedDate() %></td>
								<td>
									<form action="<%= request.getContextPath()%>/GetCategoryServlet" method="POST">
											<div class="form-group">
												<input type="hidden" value="<%= category.getCatID() %>" name="catID">
												<input type="submit" value="Edit" class="btn btn-outline-light btn-sm">
											</div>
									</form>
								</td>
								<td>
									<form action="<%= request.getContextPath()%>/DeleteCategoryServlet" onsubmit="return confirmDelete(this)" method="POST">
											<div class="form-group">
												<input type="hidden" value="<%= category.getCatID() %>" name="catID">
