		...
		<div class="row">
			<div class="col-8 offset-2">
				...
				<% 	
					...
					ArrayList<Category> arrayList = iCategoryService.getCategoryById(catID);
				%>
				...
				<form action="<%= request.getContextPath()%>/UpdateCategoryServlet" method="POST">
					...
					<div class="form-group">
						...
						<input type="hidden" class="form-control" value="<%= category.getCatID() %>" name="catID">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<%= category.getCatName() %>" placeholder="Enter Category Name" name="catName">
					</div>
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="catDesc" rows="3" name="catDescription"><%= category.getCatDesc() %></textarea>
					</div>
					
					<br>
					
					<div class="form-group">
						<label for="exampleInputEmail1">Category Updated Date</label>
						<input type="date" class="form-control" id="catCreatedDate" value="<%= category.getCatUpdatedDate() %>" placeholder="Enter Category Created Date" name="updatedDate">
					</div>
