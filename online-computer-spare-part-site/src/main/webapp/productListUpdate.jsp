			...
			<div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
				<div class="d-flex justify-content-center align-items-center h-100">
					<div class="text-white">
						<br><br><br>
						<h1 class="mb-3">Update Products</h1>
		...
		<div class="row">
			<div class="col-8 offset-2">
				...
				<%
					...
					ArrayList<Product> arrayList = iProductService.getProductById(productID);
				...
				%>
					<form action="<%= request.getContextPath() %>/UpdateProductServlet" method="post">
						...
						<div class="form-group">
							<input type="hidden" class="form-control" value="<%= productID %>" name="productID">
						</div>
					
						<div class="form-group">
							<label for="exampleInputProdut">Product Name</label>
							<input type="text" class="form-control" id="exampleInputProdut" value="<%= product.getProductName() %>" name="productname">
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description"><%= product.getProductDec() %></textarea>
						</div>
						...
						<div class="form-group">
							...
							<%
								...
								ArrayList<Category> arrayListCategory = iCategoryService.getCategories();
							%>
						...
						<div class="form-group">
							<label for="exampleInputProdut">Product Brand</label>
							<input type="text" class="form-control" id="exampleInputProdut" value="<%= product.getProductBrand() %>" name="brand">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputProdut" value="<%= product.getProductModel() %>" name="model">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputProdut" value="<%= product.getProductPrice() %>" name="price">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputProdut" value="<%= product.getProductStock() %>" name="stock">
						</div>
